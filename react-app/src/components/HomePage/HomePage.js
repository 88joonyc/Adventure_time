...
/* --------------------------return--------------------------------------------------------------- */
    ...
    return (
        ...
        {homeMain}
        {editForm ? <EditForm {...{editthisevent,venue_id, setVenue, venue, category_id, setCategory, category, name, setName, description, setDescript, start_time, setStart, setEnd, capacity, setCap, image, setImg, cost, setCost, editForm, toggleEdit}}/> : null}
        </>
    )
}
