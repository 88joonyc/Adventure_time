...
// ===========================================ticket panel===========================================================================
  ...
  if (overload) {
    paypanel = ( (/*!event?.cost &&*/ ticketqty) ? thispaypanel : shoppingcart )
  } else {
        ...
        <div className='ticketing-panel'>
          ...
          <div>
              <div className='ticket-image-container'>
                  ...
                  <img alt='' className='ticketing-image' src={event?.image}/>
              </div>
    ...
    <div className='map-info-container'>
        ...
        <div>
          <div className='map-info-marker map-info-marker-top'>
            <div>
              <img alt='' className='map-info-marker-pic'src={event?.host?.image} />
        ...
        <div className='map-map-info-box'>
          ...
          <div className='map-info-map-small'>
            {event?.venue?.address}
            {event?.venue?.city},
            {event?.venue?.state }
            {event?.venue?.zip_code}</div>
          ...
          <div className='event-page'>
            <div className='event-page-topcard'>
              <div className='event-page-img-container'>
                <img alt='' className='event-page-img'src={event?.image}/>
              </div>
              <div className="event-page-card">
                <div>
                  <p>{moment(event?.start_time).format('MMM do')}</p>
                  {(event?.name?.toString().length > 50) ? <p className='events-page-card-naem-long'>{event?.name}</p> : <p className='events-page-card-naem-short'>{event?.name}</p> }
                  {(event?.name?.toString().length > 100) ? <p className='events-page-card-naem-very-long'>{event?.name}</p> : null /*<p className='events-page-card-naem-short'>{event?.name}</p> */ }
                  ...
                  <p className='follower-number'>{event?.followers?.length} followers { follower ? <button value={follower[0]?.id} onClick={(e) => unfollow(e) } className='unfollow-me-button'>following</button> : <button onClick={() => follow()} className='follow-me-button'>follow</button> }</p>
                  ...
                  {event?.cost ? <p className='ticket-prices-start'>Tickets start at: ${event?.cost}</p> : <p className='ticket-prices-start'>Free</p>}
                </div>
              </div>
            </div>
            ...
            <div className='event-page-bot-grid'>
              ...
              <div className='side-panel-container'>
                <div className='event-page-sidepanel'>
                    ...
                    <p>Date and time</p>
                    <p>Starts: </p>
                    <p>{moment(event?.start_time?.split(' GMT').join(' EST')).format('ddd, MMMM do, YYYY [at] h:mm A')}</p>
                    <p>Ends:</p>
                    <p>{moment(event?.end_time?.split(' GMT').join(' EST')).format('ddd, MMMM do, YYYY [at] h:mm A')}</p>
