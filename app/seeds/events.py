...
def seed_events():
    ...
    hot = Event(
        host_id=3, venue_id=1, category_id=9, name='My 4th wedding', description='Come to my fourth wedding and see me cry', start_time='2021-11-01', end_time='2021-11-01', capacity=10000, image='https://images.squarespace-cdn.com/content/v1/5afeff3b85ede1f676dc7b97/1536949548287-JLSPNHW1QR2X3OJQV5KI/hm_549.jpg', cost=0)
